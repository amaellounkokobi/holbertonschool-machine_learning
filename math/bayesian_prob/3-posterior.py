...
- A that calculates the posterior probability for the
...
def posterior(x, n, P, Pr):
    """
    A function that calculates the posterior probability for
    ...
    Args:
       ...
       Pr is a 1D numpy.ndarray containing the prior beliefs of P
    Returns:
       The posterior probability of each probability in
